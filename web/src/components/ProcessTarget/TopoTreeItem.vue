    ...
    <ul class="topo-tree">
        <li
            ...
            <div
                ...
                <!-- 节点类型 -->
                <span v-if="nodeTypeMap[node.topoType]" :class="`word-icon ${ node.topoType }`">{{ nodeTypeMap[node.topoType] }}</span>
                <!-- 可勾选 -->
            ...
            <div
                ...
                <span v-else-if="!node.topoLoading && node.empty" class="node-child-empty">{{ node.emptyText || emptyChildText }}</span>
            </div>
