...
import {
    bkLink,
    bkAlert, bkBadge, bkButton, bkCheckbox, bkCheckboxGroup, bkCol, bkCollapse, bkCollapseItem, bkContainer, bkDatePicker,
    ...
    bkTimeline, bkTransfer, bkTree, bkUpload, bkClickoutside, bkTooltips, bkSwiper, bkRate, bkAnimateNumber, bkVirtualScroll, bkTableSettingContent,
    bkBigTree, bkOverflowTips, bkCascade
} from 'bk-magic-vue'
