                    ...
                    <div class="process-status" v-if="row.proc_inst_infos.length">
                        <div class="col-status-item" v-for="(instInfo, index) in row.proc_inst_infos" :key="instInfo.id">
                            ...
                            <div class="item-status">
                                ...
                                <StatusView v-else-if="instInfo.process_status === 1" type="success" :is-solid="true" :text="$t('运行中')" />
                                <StatusView v-else-if="instInfo.process_status === 2" type="failed" :is-solid="true" :text="$t('未运行')" />
                            </div>
                        </div>
                    </div>
