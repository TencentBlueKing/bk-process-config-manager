...
# CorsMiddleware 必须加到 django.contrib.sessions.middleware.SessionMiddleware 后面

session_middleware_index = MIDDLEWARE.index("django.contrib.sessions.middleware.SessionMiddleware")
MIDDLEWARE = (
    MIDDLEWARE[: session_middleware_index + 1]
    + ("corsheaders.middleware.CorsMiddleware",)
    + MIDDLEWARE[session_middleware_index + 1 :]
)

INSTALLED_APPS += ("iam.contrib.iam_migration",)
