...
MAX_DBCONN_RETRY_TIMES = getattr(settings, "MAX_DBCONN_RETRY_TIMES", 1)
            ...
            with self.wrap_database_errors:
                try:
                    ...
                    if isinstance(e, _operror_types):
                        if hasattr(self, "_connection_retries") and self._connection_retries >= MAX_DBCONN_RETRY_TIMES:
